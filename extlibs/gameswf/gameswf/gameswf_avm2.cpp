...
namespace gameswf
{
	...
	// dispatch
	{
		...
		tu_array<as_value>	local_register;
		...
		if( m_compiled_code.is_valid() )
		{
			try
			{
				m_compiled_code.call< tu_array<as_value>&, vm_stack&, vm_stack&, as_value* >
	...
	void	as_3_function::execute(tu_array<as_value>& lregister, as_environment* env, as_value* result)
	{
