...
namespace gameswf
{
	...
	struct text_character_def : public character_def
	{
		...
		rect	m_rect;
		matrix	m_matrix;
		tu_array<text_glyph_record>	m_text_glyph_records;
	...
	struct edit_text_character : public character
	{
		...
		tu_array<text_glyph_record>	m_text_glyph_records;
		tu_array<fill_style>	m_dummy_style;	// used to pass a color on to shape_character::display()
		tu_array<line_style>	m_dummy_line_style;
