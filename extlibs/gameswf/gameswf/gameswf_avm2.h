...
namespace gameswf
{
	...
	struct as_3_function : public as_function
	{
		...
		// method_info
		int m_return_type;
		tu_array<int> m_param_type;
		int m_name;
		Uint8 m_flags;
		tu_array<option_detail> m_options;
		...
		membuf m_code;
		tu_array<gc_ptr<except_info> > m_exception;
		tu_array<gc_ptr<traits_info> > m_trait;
		...
		void	execute(tu_array<as_value>& lregister, as_environment* env, as_value* result);
		void	compile();
