...
//#endif	// not __GNUC__
		...
		virtual character*	add_display_object( Uint16 character_id, const tu_string& name, const tu_array<swf_event*>& event_handlers, int depth, bool replace_if_depth_is_occupied, const cxform& color_transform, const matrix& mat, float ratio, Uint16 clip_depth, Uint8 blend_mode)
		{
			return NULL;
		}
		...
		virtual void	do_actions(const tu_array<action_buffer*>& action_list) { assert(0); }
