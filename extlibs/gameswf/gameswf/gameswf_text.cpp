...
{
	// use safe container
	static tu_array<char> s_gameswf_key_to_ascii;
	static tu_array<char> s_gameswf_key_to_ascii_shifted;
	...
	static void	display_glyph_records(
		...
		character* inst,
		const tu_array<text_glyph_record>& records,
		movie_definition_sub* root_def)
	{
		tu_array<fill_style>	dummy_style;	// used to pass a color on to shape_character::display()
		tu_array<line_style>	dummy_line_style;
