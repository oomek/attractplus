...
namespace gameswf
{
	...
	struct sprite_instance : public character
	{
		...
		tu_array<action_buffer*>	m_action_list;
		tu_array<action_buffer*>	m_goto_frame_action_list;

		play_state	m_play_state;
		int		m_current_frame;
		bool		m_update_frame;
		tu_array<bool>	m_init_actions_executed;	// a bit-array class would be ideal for this
...
//		virtual bool	has_looped() const { return m_has_looped; }
		...
		void	do_actions();
		virtual void do_actions(const tu_array<action_buffer*>& action_list);
