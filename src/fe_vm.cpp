...
bool FeVM::on_new_layout()
{
	...
	fe.Bind( _SC("Image"),
		...
		.Prop(_SC("texture_perspective"), &FeImage::get_texture_perspective, &FeImage::set_texture_perspective )
		.Prop(_SC("perspective"), &FeImage::get_perspective_coefficient, &FeImage::set_perspective_coefficient )
		.Prop(_SC("rotation_x"), &FeImage::get_rotation_x, &FeImage::set_rotation_x )
		.Prop(_SC("rotation_y"), &FeImage::get_rotation_y, &FeImage::set_rotation_y )
		.Prop(_SC("rotation_z"), &FeImage::get_rotation_z, &FeImage::set_rotation_z )
		...
		.Func(_SC("set_corners"), &FeImage::set_corners )
