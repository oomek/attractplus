...
bool FeVM::poll_command( FeInputMap::Command &c, std::optional<FeEvent> &ev, bool &from_ui )
{
	...
	else if ( const std::optional event = m_window.pollEvent() )
	{
		...
		{
			ev = event;
			const std::int64_t t = m_layout_time.getElapsedTime().asMilliseconds();
...
bool FeVM::on_new_layout()
{
	...
	ConstTable()
		...
		.Enum( _SC("Align"), Enumeration()
			.Const( _SC("Left"), FeTextPrimitive::MiddleLeft )
			.Const( _SC("Centre"), FeTextPrimitive::MiddleCentre )
			.Const( _SC("Right"), FeTextPrimitive::MiddleRight )
			.Const( _SC("Top"), FeTextPrimitive::TopCentre )
			.Const( _SC("Bottom"), FeTextPrimitive::BottomCentre )
			.Const( _SC("TopLeft"), FeTextPrimitive::TopLeft )
			.Const( _SC("TopCentre"), FeTextPrimitive::TopCentre )
			.Const( _SC("TopRight"), FeTextPrimitive::TopRight )
			.Const( _SC("BottomLeft"), FeTextPrimitive::BottomLeft )
			.Const( _SC("BottomCentre"), FeTextPrimitive::BottomCentre )
			.Const( _SC("BottomRight"), FeTextPrimitive::BottomRight )
			.Const( _SC("MiddleLeft"), FeTextPrimitive::MiddleLeft )
			.Const( _SC("MiddleCentre"), FeTextPrimitive::MiddleCentre )
			.Const( _SC("MiddleRight"), FeTextPrimitive::MiddleRight )
			)
	...
	fe.Bind( _SC("Image"),
		...
		.Prop(_SC("anchor_z"), &FeImage::get_anchor_z, &FeImage::set_anchor_z )
