...
bool FeVM::on_new_layout()
{
	...
	fe.Bind( _SC("Text"),
		...
		.Prop(_SC("bg_outline_red"), &FeText::get_bgolr, &FeText::set_bgolr )
		.Prop(_SC("bg_outline_green"), &FeText::get_bgolg, &FeText::set_bgolg )
		.Prop(_SC("bg_outline_blue"), &FeText::get_bgolb, &FeText::set_bgolb )
		.Prop(_SC("bg_outline_alpha"), &FeText::get_bgola, &FeText::set_bgola )
		.Prop(_SC("outline_red"), &FeText::get_olr, &FeText::set_olr )
		.Prop(_SC("outline_green"), &FeText::get_olg, &FeText::set_olg )
		.Prop(_SC("outline_blue"), &FeText::get_olb, &FeText::set_olb )
		.Prop(_SC("outline_alpha"), &FeText::get_ola, &FeText::set_ola )
	...
	fe.Bind( _SC("ListBox"),
		...
		.Prop(_SC("outline_red"), &FeListBox::get_olr, &FeListBox::set_olr )
		.Prop(_SC("outline_green"), &FeListBox::get_olg, &FeListBox::set_olg )
		.Prop(_SC("outline_blue"), &FeListBox::get_olb, &FeListBox::set_olb )
		.Prop(_SC("outline_alpha"), &FeListBox::get_ola, &FeListBox::set_ola )
		.Prop(_SC("sel_outline"), &FeListBox::get_sel_outline, &FeListBox::set_sel_outline )
		.Prop(_SC("sel_outline_red"), &FeListBox::get_selolr, &FeListBox::set_selolr )
		.Prop(_SC("sel_outline_green"), &FeListBox::get_selolg, &FeListBox::set_selolg )
		.Prop(_SC("sel_outline_blue"), &FeListBox::get_selolb, &FeListBox::set_selolb )
		.Prop(_SC("sel_outline_alpha"), &FeListBox::get_selola, &FeListBox::set_selola )
		...
		.Overload<void (FeListBox::*)(int, int, int)>(_SC("set_selbg_rgb"), &FeListBox::set_selbg_rgb)
		.Overload<void (FeListBox::*)(int, int, int, int)>(_SC("set_selbg_rgb"), &FeListBox::set_selbg_rgb)
