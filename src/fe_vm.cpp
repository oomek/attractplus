...
bool FeVM::on_new_layout()
{
	...
	fe.Bind( _SC("ListBox"),
		...
		.Prop(_SC("selection_mode"), &FeListBox::get_selection_mode, &FeListBox::set_selection_mode )
		.Prop(_SC("selection_margin"), &FeListBox::get_selection_margin, &FeListBox::set_selection_margin )
