...
#define ANIM_PROP( name, getter, setter ) \
	...
	fe.Bind( _SC("Image"),
		...
		.Prop(_SC("content_grid"), &FeImage::get_content_grid, &FeImage::set_content_grid )
		.Prop(_SC("content_grid_uniform"), &FeImage::get_content_grid_uniform, &FeImage::set_content_grid_uniform )
		.Prop(_SC("content_pixel_snap"), &FeImage::get_content_pixel_snap, &FeImage::set_content_pixel_snap )
		.Prop(_SC("content_grid_offset_x"), &FeImage::get_content_grid_offset_x, &FeImage::set_content_grid_offset_x )
		.Prop(_SC("content_grid_offset_y"), &FeImage::get_content_grid_offset_y, &FeImage::set_content_grid_offset_y )
