...
bool FeVM::on_new_layout()
{
	...
	fe.Bind( _SC("Image"),
		...
		.Prop(_SC("subimg_cover"), &FeImage::get_subimg_cover, &FeImage::set_subimg_cover )
		.Prop(_SC("subimg_anchor"), &FeImage::get_subimg_anchor_type, &FeImage::set_subimg_anchor_type )
		.Prop(_SC("subimg_anchor_x"), &FeImage::get_subimg_anchor_x, &FeImage::set_subimg_anchor_x )
		.Prop(_SC("subimg_anchor_y"), &FeImage::get_subimg_anchor_y, &FeImage::set_subimg_anchor_y )
		...
		.Func(_SC("set_subimg_anchor"), &FeImage::set_subimg_anchor )
