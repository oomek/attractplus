...
{
	if ( m_corner_radius.x != rx || m_corner_ratio_x || m_corner_ratio_auto )
	{
		m_corner_ratio_auto = false;
		m_corner_ratio_x = false;
...
{
	if ( m_corner_radius.y != ry || m_corner_ratio_y || m_corner_ratio_auto )
	{
		m_corner_ratio_auto = false;
		m_corner_ratio_y = false;
...
{
	if ( m_corner_radius.x != rx || m_corner_radius.y != ry || m_corner_ratio_x || m_corner_ratio_y || m_corner_ratio_auto )
	{
		m_corner_ratio_auto = false;
		m_corner_ratio_x = false;
		m_corner_ratio_y = false;
...
{
	if ( m_corner_ratio.x != rx || !m_corner_ratio_x || m_corner_ratio_auto )
	{
		m_corner_ratio_auto = false;
...
{
	if ( m_corner_ratio.y != ry || !m_corner_ratio_y || m_corner_ratio_auto )
	{
		m_corner_ratio_auto = false;
...
{
	if ( m_corner_ratio.x != rx || m_corner_ratio.y != ry || !m_corner_ratio_x || !m_corner_ratio_y || m_corner_ratio_auto )
	{
		m_corner_ratio_auto = false;
		m_corner_ratio_x = true;
		m_corner_ratio_y = true;
...
{
	if ( m_corner_ratio.x != r || m_corner_ratio.y != r || !m_corner_ratio_x || !m_corner_ratio_y || !m_corner_ratio_auto )
	{
		m_corner_ratio_auto = true;
		m_corner_ratio_x = true;
		m_corner_ratio_y = true;
		m_corner_ratio.x = r;
		m_corner_ratio.y = r;
...
void FeRectangle::update_corner_radius()
{
	...
	float rx = std::min( mx / 2, std::fabs( m_corner_radius.x ) );
	float ry = std::min( my / 2, std::fabs( m_corner_radius.y ) );
