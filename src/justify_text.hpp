...
//
// Originally SFML 3.0.1 /include/SFML/Graphics/Text.hpp
//
...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Enumeration of the string justification styles
    ///
    ////////////////////////////////////////////////////////////
    enum Justify // AM+
    {
        None          = 0, //!< No justification
        Word          = 1, //!< Justify words by increasing whitespace
        Character     = 2  //!< Justify characters by increasing letter spacing
    };
    ...
    ///
    /// Width justified strings will be adjusted to fit.
    ///
    /// \see `getWidth`
    ///
    ////////////////////////////////////////////////////////////
    void setWidth(unsigned int width); // AM+

    ////////////////////////////////////////////////////////////
    /// \brief Set the justify method
    ///
    /// \see `getJustify`
    ///
    ////////////////////////////////////////////////////////////
    void setJustify(std::uint32_t justify); // AM+
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the text's justify width
    ///
    /// \see `setWidth`
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] unsigned int getWidth() const; // AM+


    ////////////////////////////////////////////////////////////
    /// \brief Get the text's justify method
    ///
    /// \see `setJustify`
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] std::uint32_t getJustify() const; // AM+
...
private:
    ...
    ///
    ////////////////////////////////////////////////////////////
    void justifySpacing(float &whitespaceWidth, float &letterSpacing, bool isBold, float italicShear) const; // AM+
