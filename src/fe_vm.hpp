...
public:
	...
	FeImage *overlay_get_surface();
	float overlay_get_width();
	float overlay_get_height();
	FeImage *overlay_add_image(const char *,float, float, float, float);
	FeImage *overlay_add_image(const char *, float, float);
	FeImage *overlay_add_image(const char *);
	FeImage *overlay_add_artwork(const char *,float, float, float, float);
	FeImage *overlay_add_artwork(const char *, float, float);
	FeImage *overlay_add_artwork(const char *);
	FeImage *overlay_add_clone(FeImage *);
	FeText *overlay_add_text(const char *,int, int, int, int);
	FeListBox *overlay_add_listbox(int, int, int, int);
	FeRectangle *overlay_add_rectangle(float, float, float, float);
	FeImage *overlay_add_surface(float, float, int, int);
	FeImage *overlay_add_surface(int, int);
