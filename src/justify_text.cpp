...
//
// Originally SFML 3.0.0 /include/SFML/Graphics/Text.cpp
//
// - Requires patch:
//   - extlibs\SFML\include\SFML\Graphics\Texture.hpp #L715
//          friend class JustifyText;
//
...
void JustifyText::justifySpacing(float &whitespaceWidth, float &letterSpacing, bool isBold, float italicShear) const
{
    ...
    if ( m_justify == Character && chars > 1 )
    {
